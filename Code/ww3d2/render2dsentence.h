...
public:
	...
	bool Is_Clipping_Enabled( void ) const {
		return IsClippedEnabled;
	}

	void Enable_Clipping( bool onoff ) {
		IsClippedEnabled = onoff;
	}
	...
	void Set_Texture_Size_Hint( int hint ) {
		TextureSizeHint = hint;
	}

	int	Get_Texture_Size_Hint( void ) const {
		return TextureSizeHint;
	}
...
private:
	...
	struct SentenceDataStruct {
		...
		bool operator==( const SentenceDataStruct& src ) {
			return false;
		}
	...
	struct PendingSurfaceStruct {
		...
		bool operator==( const PendingSurfaceStruct& src ) {
			return false;
		}
	...
	struct RendererDataStruct {
		...
		bool operator==( const RendererDataStruct& src ) {
			return false;
		}
