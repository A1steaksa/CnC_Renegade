...
public:
   ...
   virtual void Set_Sort_Level( int level );	
	...
	void Compose_Deformed_Vertex_Buffer( VertexFormatXYZNDUV2* verts, const Vector2* uv0, const Vector2* uv1, const unsigned* diffuse );
