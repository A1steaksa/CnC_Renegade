...
public:
	...
	*/
    ...
    void Get_Position( Vector3* set_pos ) const {
        Get_Transform().Get_Translation( set_pos );
    }
	...
	*/
    ...
    WWINLINE RenderObjClass* Peek_Model(void){
        return Model;
    }
	...
	*/
	void Set_Vis_Object_ID( int new_id ){
        VisObjectID = new_id;
    }
	...
	*/
    ...
    unsigned char Get_Collision_Group(void) const {
	...
	*/
	void Set_Immovable( bool onoff ){
        Set_Flag( IMMOVABLE, onoff );
    }

	bool Is_Immovable(void) const {
	...
	*/
	void Set_Disabled( bool onoff ){
        Set_Flag( DISABLED, onoff );
    }
	...
	*/
	...
	bool Is_User_Control_Enabled(void) const {
	...
	*/
	void Enable_Shadow_Generation( bool onoff ){
        Set_Flag(CASTSHADOW,onoff);
    }

	bool Is_Shadow_Generation_Enabled(void) const {
	...
	*/
	void Enable_Force_Projection_Shadow( bool onoff ){
        Set_Flag( FORCE_PROJECTION_SHADOW, onoff );
    }
	...
	*/
	void Enable_Dont_Save( bool onoff ){
        Set_Flag( DONT_SAVE, onoff );
    }

	bool Is_Dont_Save_Enabled(void) const {
	...
	*/
	bool Is_Asleep(void) const {
        return ( ( Flags & ASLEEP ) == ASLEEP );
    }

	void Force_Awake(void){
        Set_Flag( ASLEEP, false );
    }
	...
	*/
	void Enable_Is_World_Space_Mesh( bool onoff ){
        Set_Flag( IS_WS_MESH, onoff );
    }
	
    bool Is_World_Space_Mesh(void) {
	...
	*/
	void Enable_Is_Pre_Lit( bool onoff ){
        Set_Flag( IS_PRE_LIT, onoff );
    }
	...
	** sunlight.
	*/
	void Enable_Is_In_The_Sun( bool onoff ){
        Set_Flag( IS_IN_THE_SUN, onoff );
    }

	bool Is_In_The_Sun(void){
	...
	** external user.
	*/
	void Enable_Is_State_Dirty( bool onoff ){
        Set_Flag( IS_STATE_DIRTY, onoff );
    }
	
    bool Is_State_Dirty(void){
	...
	** of objects.
	*/
	void Enable_Objects_Simulation( bool onoff ){
        Set_Flag( SIMULATION_DISABLED, !onoff );
    }
	
    bool Is_Objects_Simulation_Enabled(void) const{
	...
	*/
	void Set_Observer( PhysObserverClass* o ){
        Observer = o;
    }

	PhysObserverClass* Get_Observer(void){
        return Observer;
    }
	...
	*/
	const PhysDefClass* Get_Definition(void){
        return Definition;
    }
	...
	** Physics RTTI.
	*/
	virtual DynamicPhysClass* As_DynamicPhysClass(void){
        return NULL;
    }

	virtual MoveablePhysClass* As_MoveablePhysClass(void){
        return NULL;
    }
	...
	virtual HumanPhysClass* As_HumanPhysClass(void){
        return NULL;
    }

	virtual RigidBodyClass* As_RigidBodyClass(void){
        return NULL;
    }

	virtual VehiclePhysClass* As_VehiclePhysClass(void){
        return NULL;
    }

	virtual MotorVehicleClass* As_MotorVehicleClass(void){
        return NULL;
    }

	virtual WheeledVehicleClass* As_WheeledVehicleClass(void){
        return NULL;
    }

	virtual MotorcycleClass* As_MotorcycleClass(void){
        return NULL;
    }

	virtual TrackedVehicleClass* As_TrackedVehicleClass(void){
        return NULL;
    }

	virtual VTOLVehicleClass* As_VTOLVehicleClass(void){
        return NULL;
    }

	virtual StaticPhysClass* As_StaticPhysClass(void){
        return NULL;
    }

	virtual StaticAnimPhysClass* As_StaticAnimPhysClass(void){
        return NULL;
    }

	virtual ElevatorPhysClass* As_ElevatorPhysClass(void){
        return NULL;
    }

	virtual DamageableStaticPhysClass* As_DamageableStaticPhysClass (void){
        return NULL;
    }

	virtual DoorPhysClass* As_DoorPhysClass(void){
        return NULL;
    }

	virtual DecorationPhysClass* As_DecorationPhysClass(void){
        return NULL;
    }

	virtual TimedDecorationPhysClass* As_TimedDecorationPhysClass(void){
        return NULL;
    }

	virtual DynamicAnimPhysClass* As_DynamicAnimPhysClass(void){
        return NULL;
    }

	virtual LightPhysClass* As_LightPhysClass(void){
        return NULL;
    }

	virtual RenderObjPhysClass* As_RenderObjPhysClass(void){
        return NULL;
    }

	virtual ProjectileClass* As_ProjectileClass(void){
        return NULL;
    }

	virtual AccessiblePhysClass* As_AccessiblePhysClass(void){
        return NULL;
    }
	...
	*/
	...
	unsigned Get_Last_Visible_Frame() const {
        return LastVisibleFrame;
    }

	void Set_Last_Visible_Frame( unsigned frame ){
