...
public:
	...
	static void Set_Map_Filename( const char* filename ){
		MapFilename = filename;
	}

	static const char* Get_Map_Filename(void){
		return MapFilename;
	}
	
	// Description access
	static void Set_Description( const WCHAR* text ){
		Description = text;
	}

	static const WCHAR* Get_Description(void){
		return Description;
	}

	// Mission description access
	static int Get_Mission_Description_ID(void){
		return MissionDescriptionID;
	}

	static void	Set_Mission_Description_ID( int id ){
		MissionDescriptionID = id;
	}
	...
	static const char* Get_Current_Game_Filename(void){
