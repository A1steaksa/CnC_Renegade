...
public:
    ...
    FileFactoryClass* Peek_Temp_FileFactory(void){
        return TempFactory;
    }
	...
	static FileFactoryListClass* Get_Instance(void){
        return Instance;
    }

	int Get_Factory_Count(void) const {
        return FactoryList.Count();
    }

	FileFactoryClass* Get_Factory( int index ){
