...
public:
    ...
    static	SList<BaseGameObj>* Get_Game_Obj_List( void ) {
        return &GameObjList;
    }

    // SmartGameObjs
    static void Add_Smart( SmartGameObj* obj ) {
        SmartGameObjList.Add_Tail( obj );
    }

    static void Remove_Smart( SmartGameObj* obj ) {
        SmartGameObjList.Remove( obj );
    }

    static	SList<SmartGameObj>* Get_Smart_Game_Obj_List( void ) {
        return &SmartGameObjList;
    }

    // Star GameObjs
    static void Add_Star( SoldierGameObj* obj ) {
        StarGameObjList.Add_Tail( obj );
    }
    static void Remove_Star( SoldierGameObj* obj ) {
        StarGameObjList.Remove( obj );
    }
    static SList<SoldierGameObj>* Get_Star_Game_Obj_List( void ) {
        return &StarGameObjList;
    }
    ...
    static void Add_Building( BuildingGameObj* obj ) {
        BuildingGameObjList.Add_Tail( obj );
    }
    static void Remove_Building( BuildingGameObj* obj ) {
        BuildingGameObjList.Remove( obj );
    }
    static SList<BuildingGameObj>* Get_Building_Game_Obj_List( void ) {
        return &BuildingGameObjList;
    }
    ...
    // Cinematic Freeze
    static bool Is_Cinematic_Freeze_Active( void ) {
        return CinematicFreezeActive;
    }
    static void Activate_Cinematic_Freeze( bool activate ) {
        CinematicFreezeActive = activate;
    }
    static void Toggle_Cinematic_Freeze( void ) {
        CinematicFreezeActive = !CinematicFreezeActive;
    }
