...
// Physics
    WWINLINE PhysClass* Peek_Physical_Object( void ) const {
        return PhysObj;
    }
    ...
    // Targeting
    float Get_Bullseye_Offset_Z( void ) const {
    ...
    virtual	bool Takes_Explosion_Damage( void ) {
        return true;
    }
    ...
    virtual	PowerUpGameObj* As_PowerUpGameObj( void ) {
    ...
    virtual C4GameObj* As_C4GameObj( void ) {
        return (C4GameObj*) NULL;
    }

    virtual	BeaconGameObj* As_BeaconGameObj( void ) {
        return (BeaconGameObj*) NULL;
    }

    virtual	ArmedGameObj* As_ArmedGameObj( void ) {
        return (ArmedGameObj*) NULL;
    }

    virtual	CinematicGameObj* As_CinematicGameObj( void ) {
        return NULL;
    }

    virtual	SimpleGameObj* As_SimpleGameObj( void ) {
        return NULL;
    }
    ...
    // Radar Blips
    int Get_Radar_Blip_Shape_Type( void ) {
        return RadarBlipShapeType;
    }

    void Set_Radar_Blip_Shape_Type( int type ) {
        RadarBlipShapeType = type;
    }

    void Reset_Radar_Blip_Shape_Type( void ) {
        RadarBlipShapeType = Get_Definition().RadarBlipType;
    }

    int Get_Radar_Blip_Color_Type( void ) {
        return RadarBlipColorType;
    }

    void Set_Radar_Blip_Color_Type( int type ) {
        RadarBlipColorType = type;
    }

    void Reset_Radar_Blip_Color_Type( void );

    float Get_Radar_Blip_Intensity( void ) {
        return RadarBlipIntensity;
    }

    void Set_Radar_Blip_Intensity( float value ) {
        RadarBlipIntensity = value;
    }
...
//
    ...
    void Enable_Innate_Conversations( bool enable ) {
        IsInnateConversationsEnabled = enable;
    }

    bool Is_In_Conversation( void ) const {
    ...
    bool Is_HUD_Pokable_Indicator_Enabled( void ) {
