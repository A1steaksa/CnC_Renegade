...
public:
	...
	static void Set_Bracket_Object( const PhysicalGameObj* obj ){
		BracketObj = obj;
	}
	...
	static	int	Get_Num_Blip_Shape_Types(void){
		return NUM_BLIP_SHAPE_TYPES;
	}
	...
	static void Add_Marker( const RadarMarkerClass& marker ){
		Markers.Add( marker );
	}
	...
	// Multiplayer support
   	static void Set_Radar_Mode( RadarModeEnum mode ){
		RadarMode = mode;
	}

   	static RadarModeEnum Get_Radar_Mode(void){
		return RadarMode;
	}
