...
public:
	...
	bool operator == ( const AmmoDefinitionClass & vector) const {
		return false;
	}
	bool operator != ( const AmmoDefinitionClass & vector) const {
		return true;
...
public:
	...
	static	bool	Is_Weapon_Help_Disabled( void )	{
		return IsWeaponHelpDisabled;
	}
	static void	Set_Weapon_Help_Disabled( bool state ) {
		IsWeaponHelpDisabled = state;
	}
private:
