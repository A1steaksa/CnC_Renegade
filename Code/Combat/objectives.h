...
public:
	...
	static int Get_Objective_Count(void){
		return ObjectiveList.Count();
	}

	static Objective* Get_Objective( int index ){
		return ObjectiveList[index];
	}

	static bool Is_Objective_Debug_Mode_Enabled(void){
		return DebugMode;
	}
	...
	static bool Is_Viewer_Displayed(void){
		return Viewer.Is_Displayed();
	}
	static void Display_Viewer( bool onoff ){
		Viewer.Display( onoff );
	}
	static void Page_Down_Viewer(void){
		Viewer.Page_Down();
	}
	static void Render_Viewer(void){
		Viewer.Render();
	}
	static void Reload_Viewer(void){
		Viewer.Initialize();
	}
	...
	static bool Are_HUD_Objectives_Changed(void){
		return HUDUpdate;
	}

	static void Clear_HUD_Objectives_Changed(void){
		HUDUpdate = false;
	}
