...
public:
	...
	static FontCharsClass* Peek_Font( FONT_STYLE style ){
		return Fonts[style];
	}
	...
	// Color methods
	static uint32 Get_Text_Color(void){
		return TextColor;
	}

	static uint32 Get_Text_Shadow_Color(void){
		return TextShadowColor;
	}

	static uint32 Get_Disabled_Text_Color(void){
		return DisabledTextColor;
	}

	static uint32 Get_Disabled_Text_Shadow_Color(void){
		return DisabledTextShadowColor;
	}

	static uint32 Get_Line_Color(void){
		return LineColor;
	}

	static uint32 Get_Bk_Color(void){
		return BkColor;
	}

	static uint32 Get_Disabled_Line_Color(void){
		return DisabledLineColor;
	}

	static uint32 Get_Disabled_Bk_Color(void){
		return DisabledBkColor;
	}

	static uint32 Get_Tab_Text_Color(void){
		return TabTextColor;
	}

	static uint32 Get_Tab_Glow_Color(void){
		return TabGlowColor;
	}
