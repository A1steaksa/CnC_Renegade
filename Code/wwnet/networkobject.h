...
public:
	...
	//
	void Set_App_Packet_Type (BYTE type) {
        AppPacketType = type;
    }

	BYTE Get_App_Packet_Type (void) {
    ...
    void Reset_Import_State_Count(void) {
        ImportStateCount = 0;
    }

	void Increment_Import_State_Count(void) {
        ImportStateCount++;
    }

	int Get_Import_State_Count(void) {
    ...
    ULONG Get_Last_Clientside_Update_Time(void) {
	...
	//
	unsigned char Get_Frequent_Update_Export_Size(void) {
        return FrequentExportPacketSize;
    }

	void Set_Frequent_Update_Export_Size( unsigned char size ){
        FrequentExportPacketSize = size;
    }
	...
	void Set_Unreliable_Override( bool flag ) {
        UnreliableOverride = flag;
    }

	bool Get_Unreliable_Override(void) {
	...
	//	Static methods
	//
	static void Set_Is_Server(bool flag) {
        IsServer = flag;
    }
    ...
    void Set_Last_Object_Id_I_Damaged( int id ) {
        LastObjectIdIDamaged = id;
    }
	
    int Get_Last_Object_Id_I_Damaged(void) const {
        return LastObjectIdIDamaged;
    }

    void Set_Last_Object_Id_I_Got_Damaged_By( int id ) {
        LastObjectIdIGotDamagedBy = id;
    }

	int Get_Last_Object_Id_I_Got_Damaged_By(void) const	{
