...
class	cGameDataSinglePlayer : public cGameData {
	public:
		...
		bool Is_Single_Player(void) const {
			return true;
		}

		cGameDataSinglePlayer* As_Single_Player(void){
			return this;
		}

		static const WCHAR* Get_Static_Game_Name(void);

		virtual const WCHAR* Get_Game_Name(void) const {
			return this->Get_Static_Game_Name();
		}

      	virtual GameTypeEnum Get_Game_Type(void) const {
			return GAME_TYPE_SINGLE_PLAYER;
		}
